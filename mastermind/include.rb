module Interface
    ...
    def game_io(message, add_text="")
        messages = {
            ...
            "breaker" => "Correct guesses in the correct position will be shown in #{"blue".blue}."\
            ...
            "computer" => "Computer is making a guess at the 6 letter code, (y)ellow, (g)reen, (b)lue, (r)ed, (p)ink, (w)hite - guess No.",
